...
weights: (local) pretrained_models/age_only_resnet50_weights.061-3.300-4.410.hdf5 — place the weights in this local path or provide --weight_file when running the demo
